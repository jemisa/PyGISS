from tkinter import*;w=Tk();c=Canvas(w,width=1500,height=900,bg='blue');c.pack();from tkinter import filedialog as d;
f=d.askopenfilenames();c.bind('<MouseWheel>',lambda e:c.scale('all',e.x,e.y,(e.delta>0)*2or 0.5,(e.delta>0)*2or 0.5))
